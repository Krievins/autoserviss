    ...
    <div class="addcar">
        ...
        @csrf
            <div class="addcar__box">
                <h1 class="addcar__box--heading">Labot Automašīnu - {{$cars->number_plate}}</h1>
            </div>
            <div class="addcar__formbox">
                    ...
                    <div id="car_left" class="addcar__formbox__form__left">
                        ...
                        <input class="addcar__formbox__form__left--input" value="{{$cars->vin}}" type="text" name="vin" id="vin" required>
                        {{-- Owner Name --}}
                        <label class="addcar__formbox__form__left--label" for="owner_name">Vārds</label>
                        <input class="addcar__formbox__form__left--input" value="{{$cars->owner_name}}" type="text" name="owner_name" id="owner_name" required>
                        {{-- Owner Phone Number --}}
                        <label class="addcar__formbox__form__left--label" for="owner_phone">Īpašnieka Telefona Nummurs</label>
                        <input class="addcar__formbox__form__left--input" type="text" value="{{$cars->owner_phone}}" name="owner_phone" id="owner_phone" required>
                        {{-- Number Plate --}}
                        <label class="addcar__formbox__form__left--label" for="number_plate">Mašīnas Numura Zīme</label>
                        <input class="addcar__formbox__form__left--input" value="{{$cars->number_plate}}" type="text" name="number_plate" id="number_plate" required>
                        {{-- Make --}}
                        <label class="addcar__formbox__form__left--label" for="number_plate">Mašīnas Marka</label>
                        <input class="addcar__formbox__form__left--input" value="{{$cars->brand}}" type="text" name="brand" id="make" required>
                        {{-- Model --}}
                        <label class="addcar__formbox__form__left--label" for="number_plate">Mašīnas Modelis</label>
                        <input class="addcar__formbox__form__left--input" type="text" value="{{$cars->model}}" name="model" id="model" required>
                    </div>
                    <div id="car_right" class="addcar__formbox__form__right">
                        ...
                        <input class="addcar__formbox__form__right--input" value="{{$cars->release_year}}" type="text" name="release_year" id="release_year" required>
                        {{-- Body Type --}}
                        <label class="addcar__formbox__form__right--label" for="number_plate">Virsbūves Tips</label>
                        <input class="addcar__formbox__form__right--input" value="{{$cars->body_type}}" type="text" name="body_type" id="body_type" required>
                        {{-- Engine CM3 --}}
                        <label class="addcar__formbox__form__right--label" for="number_plate">Motora Tilpums (CCM)</label>
                        <input class="addcar__formbox__form__right--input" value="{{$cars->motor}}" type="text" name="motor" id="motor" required>
                        {{-- Fuel Type --}}
                        <label class="addcar__formbox__form__right--label" for="number_plate">Degvielas Tips</label>
                        <input class="addcar__formbox__form__right--input" value="{{$cars->fuel_type}}" type="text" name="fuel_type" id="fuel_type" required>
                        {{-- Drive --}}
                        <label class="addcar__formbox__form__right--label" for="number_plate">Piedziņas Tips</label>
                        <input class="addcar__formbox__form__right--input" value="{{$cars->drive_type}}" type="text" name="drive_type" id="drive_type" required>
                        {{-- Sequential Number --}}
                        <label class="addcar__formbox__form__right--label" for="number_plate">Ātrumkārbas Nummurs</label>
                        <input class="addcar__formbox__form__right--input" value="{{$cars->sql_number}}" type="text" name="sql_number" id="sql_number" required>
